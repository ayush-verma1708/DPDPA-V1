...
//   useEffect(() => {
//     if (currentUsername) {
//       const filteredStatuses = fetchedStatuses.filter(
//         (status) => status.username === currentUsername
//       );
...
//                       <TableCell>
//                         {status.controlId?.fixed_id || 'N/A'}
//                       </TableCell>
//                       <TableCell>
//                         {status.familyId?.fixed_id || 'N/A'}
//                       </TableCell>
...
//                           ('Admin' && (
//                             <Button
//                               onClick={() => handleConfirmEvidence(status._id)}
//                             >
//                               Confirm Evidence
//                             </Button>
//                           ))}
