...
const ActionCompletionCell = ({ 
  ...
  const checkCompletionStatus = useCallback(async (actionId, assetId, scopeId, controlId, familyId) => {
    try {
      const params = {
        actionId,
        assetId,
  ...
  }, [action._id, selectedAssetId, selectedScopeId, selectedControlId, expandedFamilyId, checkCompletionStatus]);
