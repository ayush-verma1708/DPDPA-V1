...
const RiskDashboard = () => {
  ...
  return (
    <Box sx={{ padding: 4 }}>
            ...
            {filteredRisks
              ...
              .map((risk) => (
                <TableRow key={`${risk.assetId}-${risk.scopeId}`}>
                  ...
                  <TableCell>
                    {risk.scopeId === 'no-scope'
                      ? ''
                      : scopeNames[risk.scopeId] || ''}{' '}
                    {/* Display scope name or blank */}
                  </TableCell>
                  <TableCell>
      ...
      <Typography variant='h6'>Overall Risk by Criticality</Typography>
...
//                 {filteredScopes.map((scopeId) => (
//                   <MenuItem key={scopeId} value={scopeId}>
//                     {scopeId === 'no-scope' ? 'No Scope' : `Scope ${scopeId}`} {/* Display 'No Scope' */}
//                   </MenuItem>
//                 ))}
//               </Select>
//             </FormControl>
...
//                   <TableCell>{risk.assetName}</TableCell>
//                   <TableCell>
//                     {risk.scopeId === 'no-scope' ? 'No Scope' : risk.scopeId} {/* Display 'No Scope' */}
//                   </TableCell>
//                   <TableCell>
//                     {risk.criticalities[selectedCriticality]}
//                   </TableCell>
...
// //   ToggleButtonGroup,
// // } from '@mui/material';
// // import { getAssetNameById, getScopeNameById } from '../api/assetApi.js'; // Import your function

// // const RiskDashboard = () => {
// //   const [overallRisk, setOverallRisk] = useState(null);
// //   const [assetNames, setAssetNames] = useState({});
// //   const [scopeNames, setScopeNames] = useState({}); // State for scope names
// //   const [loading, setLoading] = useState(true);
// //   const [error, setError] = useState(null);
// //   const [selectedAsset, setSelectedAsset] = useState('');
// //   const [selectedScope, setSelectedScope] = useState('');
...
// //       // Fetch scope names based on the scope IDs in risk data
// //       const scopeIds = [
// //         ...new Set(riskData.assetRisks.map((risk) => risk.scopeId)),
// //       ];
// //       const scopeNamesResponse = await Promise.all(
// //         scopeIds.map((id) => getScopeNameById(id)) // Assume you have this function
// //       );

// //       const scopeNamesMap = scopeIds.reduce((acc, id, index) => {
// //         acc[id] = scopeNamesResponse[index]?.name || 'Unknown'; // Adjust based on your API structure
// //         return acc;
// //       }, {});

// //       setScopeNames(scopeNamesMap); // Store scope names
// //     } catch (error) {
// //       console.error('Error fetching overall risk:', error);
// //       setError('Failed to fetch data. Please try again later.');
// //     } finally {
...
// //                 {filteredScopes.map((scopeId) => (
// //                   <MenuItem key={scopeId} value={scopeId}>
// //                     {scopeNames[scopeId] || `Scope ${scopeId}`}{' '}
// //                     {/* Display scope name */}
// //                   </MenuItem>
// //                 ))}
// //               </Select>
...
// //             <TableRow>
// //               <TableCell>Asset Name</TableCell>
// //               <TableCell>Scope Name</TableCell> {/* Change to Scope Name */}
...
// //                   <TableCell>{risk.assetName}</TableCell>
// //                   <TableCell>
// //                     {scopeNames[risk.scopeId] || `Scope ${risk.scopeId}`}
// //                   </TableCell>{' '}
// //                   <TableCell>
// //                     {risk.criticalities[selectedCriticality]}
// //                   </TableCell>
...
// //                   <TableCell>{risk.assetName}</TableCell>
// //                   <TableCell>
// //                     {risk.scopeId === 'no-scope' ? 'No Scope' : risk.scopeId}
// //                   </TableCell>{' '}
// //                   {/* Display 'No Scope' */}
// //                   <TableCell>
// //                     {risk.criticalities[selectedCriticality]}
