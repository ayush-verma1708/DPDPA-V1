...
//                 <TableCell>{action.fixed_id}</TableCell>
//                 <TableCell>{action.variable_id}</TableCell>
//                 <TableCell>{action.control ? action.control.fixed_id : 'N/A'}</TableCell>
//                 <TableCell>{action.isDPDPA ? 'Yes' : 'No'}</TableCell>
//                 <TableCell>
//                   <Button onClick={() => {
//                     setEditingAction(action);
...
// // //                 label="Variable ID"
// // //                 value={editingAction ? editAction.variable_id : newAction.variable_id}
// // //                 onChange={(e) => editingAction ? setEditAction({ ...editAction, variable_id: e.target.value }) : setNewAction({ ...newAction, variable_id: e.target.value })}
// // //                 required
// // //                 fullWidth
// // //                 margin="normal"
// // //               />
...
// // //                 <TableCell>{action.variable_id ? 'Yes' : 'No'}</TableCell>
// // //                 <TableCell>
// // //                   <Button onClick={() => setEditingAction(action)} disabled={action.isDPDPA}  >Edit</Button>
// // //                   <Button onClick={() => handleDeleteAction(action._id)} color="error" disabled={action.isDPDPA}  >Delete</Button>
// // //                 </TableCell>
// // //               </TableRow>
// // //             ))}
...
// // // //   const checkFixedIdExists = async (fixed_id) => {
// // // //     try {
// // // //       const response = await axios.get(`http://localhost:8021/api/v1/actions?fixed_id=${fixed_id}`);
// // // //       return response.data.length > 0;
// // // //     } catch (error) {
// // // //       console.error('Error checking fixed_id:', error);
// // // //       return false;
// // // //     }
// // // //   };
...
// // // //   const handleAddAction = async () => {
// // // //     try {
// // // //       if (await checkFixedIdExists(newAction.fixed_id)) {
// // // //         alert('An action with this fixed_id already exists. Please choose a different ID.');
// // // //         return;
// // // //       }
// // // //       const response = await axios.post('http://localhost:8021/api/v1/actions', newAction);
// // // //       setActions([...actions, response.data]);
...
// // // //               </Button>
// // // //               {editingAction && <Button type="button" variant="outlined" color="secondary" onClick={() => { setEditingAction(null); setEditAction({ variable_id: '', control_Id: '', isDPDPA: false }); }}>Cancel</Button>}
// // // //             </Box>
// // // //           </Box>
// // // //         </form>
// // // //       </div>
...
// // // //                 <TableCell>
// // // //                   {action.control_Id
// // // //                     ? controls.find(control => control._id === action.control_Id)?.fixed_id || 'N/A'
// // // //                     : 'N/A'}
// // // //                 </TableCell>
// // // //                 <TableCell>
// // // //                   <Button
...
// // // // //   const [actions, setActions] = useState([]);
// // // // //   const [controls, setControls] = useState([]);
// // // // //   const [newAction, setNewAction] = useState({ fixed_id: '', variable_id: '', description: '', control_Id: '' });
// // // // //   const [editingAction, setEditingAction] = useState(null);
// // // // //   const [editAction, setEditAction] = useState({ fixed_id: '', variable_id: '', description: '', control_Id: '' });
// // // // //   const [page, setPage] = useState(0);
// // // // //   const [rowsPerPage, setRowsPerPage] = useState(5);
// // // // //   const [loading, setLoading] = useState(true);
...
// // // // //       const response = await axios.post('http://localhost:8021/api/v1/actions', newAction);
// // // // //       setActions([...actions, response.data]);
// // // // //       setNewAction({ fixed_id: '', variable_id: '', description: '', control_Id: '' });
// // // // //     } catch (error) {
// // // // //       console.error('Error adding action:', error.response ? error.response.data : error.message);
// // // // //     }
// // // // //   };
...
// // // // //       ));
// // // // //       setEditingAction(null);
// // // // //       setEditAction({ fixed_id: '', variable_id: '', description: '', control_Id: '' });
// // // // //     } catch (error) {
// // // // //       console.error('Error updating action:', error.response ? error.response.data : error.message);
// // // // //     }
// // // // //   };
...
// // // // //               {/* <TextField
// // // // //                 label="Fixed ID"
// // // // //                 value={editingAction ? editAction.fixed_id : newAction.fixed_id}
// // // // //                 onChange={(e) => editingAction ? setEditAction({ ...editAction, fixed_id: e.target.value }) : setNewAction({ ...newAction, fixed_id: e.target.value })}
// // // // //                 required
// // // // //                 fullWidth
// // // // //                 margin="normal"
// // // // //               /> */}
...
// // // // //                 {editingAction ? 'Save' : 'Add'}
// // // // //               </Button>
// // // // //               {editingAction && <Button type="button" variant="outlined" color="secondary" onClick={() => { setEditingAction(null); setEditAction({ fixed_id: '', variable_id: '', description: '', control_Id: '' }); }}>Cancel</Button>}
// // // // //             </Box>
// // // // //           </Box>
// // // // //         </form>
// // // // //       </div>
...
// // // // //                 {/* <TableCell>{action.control_Id ? controls.find(control => control._id === action.control_Id)?.fixed_id : 'N/A'}</TableCell> */}
// // // // //                 <TableCell>
// // // // //   {action.control_Id
// // // // //     ? controls.find(control => control._id === action.control_Id)?.fixed_id || 'N/A'
// // // // //     : 'N/A'}
