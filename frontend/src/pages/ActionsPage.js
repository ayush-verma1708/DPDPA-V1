  ...
  const handleAddAction = async () => {
    try {
      ...
      setActions((prevActions) =>
        [...prevActions, response.data].sort((a, b) =>
          a.fixed_id.localeCompare(b.fixed_id)
        )
      );
      handleCloseDialog();
    } catch (error) {
    ...
    try {
      ...
      setActions((prevActions) =>
        prevActions
          ...
          .sort((a, b) => a.fixed_id.localeCompare(b.fixed_id))
      );
      handleCloseDialog();
    } catch (error) {
      console.error(
    ...
    <div className='p-4'>
      ...
      <TableContainer component={Paper}>
        <Table>
          ...
          <TableBody>
            {actions
              .sort((a, b) => a.fixed_id.localeCompare(b.fixed_id)) // Sort by fixed_id
